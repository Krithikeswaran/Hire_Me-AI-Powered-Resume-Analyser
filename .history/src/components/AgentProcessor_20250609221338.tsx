      ...
      <Card className="border-0 shadow-lg bg-white/80 backdrop-blur-sm">
        <CardHeader className="text-center pb-4">
          ...
          <p className="text-muted-foreground">
            Analyzing {resumes.length} resumes with {usingGemini ? 'Gemini Pro AI' : 'optimized AI models'}
          ...
          <div className={`flex items-center justify-center gap-2 text-sm p-2 rounded ${
            ...
            {usingGemini ? 'Using Gemini Pro for maximum accuracy and comprehensive analysis' : 'Using lightweight models for fast, accurate analysis'}
          </div>
        </CardHeader>
        <CardContent>
          <div className="space-y-6">
