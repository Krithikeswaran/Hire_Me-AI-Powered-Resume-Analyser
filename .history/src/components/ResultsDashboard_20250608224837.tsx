...
const ResultsDashboard = ({ results, jobDescription, onBack }) => {
  ...
  const candidate = results.topCandidates[selectedCandidate];
          ...
          <div className="flex items-center justify-between">
            <div>
              <CardTitle className="text-2xl font-bold flex items-center gap-3">
                ...
                Top 3 Candidates for {jobDescription.jobTitle}
              </CardTitle>
              <p className="text-blue-100 mt-2">
                AI-powered analysis of {results.summary.totalAnalyzed} candidates completed in {results.summary.processingTime}
              </p>
            </div>
            <Button 
          ...
          <CardContent className="p-4">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-2xl font-bold">{results.summary.totalAnalyzed}</p>
              </div>
            </div>
          </CardContent>
        </Card>
          ...
          <CardContent className="p-4">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-2xl font-bold">{results.summary.averageScore}%</p>
              </div>
            </div>
          </CardContent>
        </Card>
          ...
          <CardContent className="p-4">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-2xl font-bold">{results.summary.topCandidateScore}%</p>
              </div>
            </div>
          </CardContent>
        </Card>
              ...
              <div className="grid md:grid-cols-2 gap-4">
                ...
                <div className="space-y-3">
                  <div>
                    ...
                    <Progress value={candidate.communicationScore} className="h-2" />
                  </div>
