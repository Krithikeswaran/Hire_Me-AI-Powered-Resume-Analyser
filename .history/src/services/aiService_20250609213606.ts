...
export const analyzeResume = async (resumeText: string, jobDescription: any, resumeFile?: File) => {
  try {
    ...
    if (hasGeminiKey() && resumeFile) {
      console.log('🌟 Gemini API key detected - enhanced analysis available!');
      // TODO: Re-enable Gemini after fixing import issues
      console.log('⚠️ Gemini temporarily disabled, using local analysis');
    }
